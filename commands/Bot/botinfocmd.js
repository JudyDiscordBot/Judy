...
exports.help = {
  ...
  categoria: 'BOT',
  permissões: [],
  permissõesbot: ['Enviar mensagens', 'Enviar Embeds e Links', 'Adicionar Reações'],
  descrição: 'Veja informações sobre o bot',
  use: 'botinfo'
} 
